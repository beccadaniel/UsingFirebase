...
public class FirebaseUtil {
            ...
            mAuthStateListener = new FirebaseAuth.AuthStateListener() {
                ...
                public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                    ...
                    Toast.makeText(callerActivity.getBaseContext(),
                            callerActivity.getString(R.string.welcome_back), Toast.LENGTH_SHORT).show();
                }
            };
            connectStorage();
        }
    ...
    private static void checkAdmin(String userId) {
        ...
        DatabaseReference reference = mFirebaseDatabase.getReference()
                .child(Constants.Misc.ADMINISTRATORS).child(userId);
    ...
    public static void connectStorage() {
        ...
        mStorageReference = mFirebaseStorage.getReference().child(Constants.Misc.DEALS_PICTURES);
    }
}
